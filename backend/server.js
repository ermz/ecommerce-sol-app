...
// The PaymentProcessor.json file was created after we migrated the contracts. This will give us access to the contract abi
...
const listenToEvents = () => {
	//Both of these are in reference to ganache
